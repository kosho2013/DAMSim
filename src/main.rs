...
fn main() {
	...
	for i in 0..num_config
	{
		...
		// 	// NoC global links
		// 	let mut sender_map_noc_global = HashMap::new();
		// 	let mut receiver_map_noc_global = HashMap::new();
		...
		// 			}
		// 			sender_map_noc_global.insert(ele.clone(), tmp_sender);
		// 			receiver_map_noc_global.insert(ele.clone(), tmp_receiver);
		// 		}
		// 	}
		...
		// 		if receiver_map_noc_global.contains_key(&(x-1, y, "S".to_owned(), x, y, "N".to_owned()))
		// 		{
		// 			let mut N_in = receiver_map_noc_global.remove(&(x-1, y, "S".to_owned(), x, y, "N".to_owned())).unwrap();
		// 			for _ in 0..num_vc
		// 			{
		// 				let tmp = N_in.remove(0);
		// 				router_in_stream.push(tmp);
		// 			}
		...
		// 		if receiver_map_noc_global.contains_key(&(x+1, y, "N".to_owned(), x, y, "S".to_owned()))
		// 		{
		// 			let mut S_in = receiver_map_noc_global.remove(&(x+1, y, "N".to_owned(), x, y, "S".to_owned())).unwrap();
		// 			for _ in 0..num_vc
		// 			{
		// 				let tmp = S_in.remove(0);
		// 				router_in_stream.push(tmp);
		// 			}
		...
		// 		if receiver_map_noc_global.contains_key(&(x, y+1, "W".to_owned(), x, y, "E".to_owned()))
		// 		{
		// 			let mut E_in = receiver_map_noc_global.remove(&(x, y+1, "W".to_owned(), x, y, "E".to_owned())).unwrap();
		// 			for _ in 0..num_vc
		// 			{
		// 				let tmp = E_in.remove(0);
		// 				router_in_stream.push(tmp);
		// 			}
		...
		// 		if receiver_map_noc_global.contains_key(&(x, y-1, "E".to_owned(), x, y, "W".to_owned()))
		// 		{
		// 			let mut W_in = receiver_map_noc_global.remove(&(x, y-1, "E".to_owned(), x, y, "W".to_owned())).unwrap();
		// 			for _ in 0..num_vc
		// 			{
		// 				let tmp = W_in.remove(0);
		// 				router_in_stream.push(tmp);
		// 			}
		...
		// 		if sender_map_noc_global.contains_key(&(x, y, "N".to_owned(), x-1, y, "S".to_owned()))
		// 		{
		// 			let mut N_out = sender_map_noc_global.remove(&(x, y, "N".to_owned(), x-1, y, "S".to_owned())).unwrap();
		// 			for _ in 0..num_vc
		// 			{
		// 				let tmp = N_out.remove(0);
		// 				router_out_stream.push(tmp);
		// 			}
		...
		// 		if sender_map_noc_global.contains_key(&(x, y, "S".to_owned(), x+1, y, "N".to_owned()))
		// 		{
		// 			let mut S_out = sender_map_noc_global.remove(&(x, y, "S".to_owned(), x+1, y, "N".to_owned())).unwrap();
		// 			for _ in 0..num_vc
		// 			{
		// 				let tmp = S_out.remove(0);
		// 				router_out_stream.push(tmp);
		// 			}
		...
		// 		if sender_map_noc_global.contains_key(&(x, y, "E".to_owned(), x, y+1, "W".to_owned()))
		// 		{
		// 			let mut E_out = sender_map_noc_global.remove(&(x, y, "E".to_owned(), x, y+1, "W".to_owned())).unwrap();
		// 			for _ in 0..num_vc
		// 			{
		// 				let tmp = E_out.remove(0);
		// 				router_out_stream.push(tmp);
		// 			}
		...
		// 		if sender_map_noc_global.contains_key(&(x, y, "W".to_owned(), x, y-1, "E".to_owned()))
		// 		{
		// 			let mut W_out = sender_map_noc_global.remove(&(x, y, "W".to_owned(), x, y-1, "E".to_owned())).unwrap();	
		// 			for _ in 0..num_vc
		// 			{
		// 				let tmp = W_out.remove(0);
		// 				router_out_stream.push(tmp);
		// 			}
		...
		// 			let to_router_adapter = to_router_adapter::new(router_receiver_vec, pcu_sender_vec_tmp.len(), tmp_sender, num_input, num_vc, dummy);
		// 			parent.add_child(to_router_adapter);

		// 			for _ in 0..num_vc
		// 			{
		// 				let tmp = tmp_receiver.remove(0);
		// 				router_in_stream.push(tmp);
		// 			}
		...
		// 			{
		// 				let tmp = tmp_receiver.remove(0);
		// 				let con = ConsumerContext::new(tmp);
		// 				parent.add_child(con);
		// 			}
		...
		// 			let mut tmp_sender1 = vec![];
		// 			let mut tmp_receiver1 = vec![];
		// 			let mut tmp_sender2 = vec![];
		...
		// 				tmp_receiver2.push(receiver2);
		// 			}
					

		// 			for _ in 0..num_vc
		// 			{
		// 				let tmp = tmp_receiver1.remove(0);
		// 				router_in_stream.push(tmp);
		// 			}
					
		// 			for _ in 0..num_vc
		// 			{
		// 				let tmp = tmp_sender2.remove(0);
		// 				router_out_stream.push(tmp);
		// 			}
		...
		// 			let to_router_adapter = to_router_adapter::new(router_receiver_vec, pcu_sender_vec_tmp.len(), tmp_sender1, num_input, num_vc, dummy);
		// 			parent.add_child(to_router_adapter);
		...
		// 			let from_router_adapter = from_router_adapter::new(tmp_receiver2, router_sender_vec, pcu_receiver_vec_tmp.len(), x, y, num_input, num_vc, dummy);
		// 			parent.add_child(from_router_adapter);
		...
		// 			let to_router_adapter = to_router_adapter::new(router_receiver_vec, pmu_sender_vec_tmp.len(), tmp_sender, num_input, num_vc, dummy);
		// 			parent.add_child(to_router_adapter);
		...
		// 			let to_router_adapter = to_router_adapter::new(router_receiver_vec, pmu_sender_vec_tmp.len(), tmp_sender1, num_input, num_vc, dummy);
		// 			parent.add_child(to_router_adapter);
		...
		// 			let from_router_adapter = from_router_adapter::new(tmp_receiver2, router_sender_vec, pmu_receiver_vec_tmp.len(), x, y, num_input, num_vc, dummy);
		// 			parent.add_child(from_router_adapter);
